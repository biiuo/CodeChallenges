/*
  ...
  - You are about to drop the column `codigo` on the `User` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "public"."User_codigo_key";

-- AlterTable
ALTER TABLE "User" DROP COLUMN "codigo",
